const {isNumeric, isAlpha , isAlphaSpace ,isEmail ,isDateTime } = require('./modules/types');
...
validator = (input_obj , schema ) => {
    ...
    if(errors.length >0){
        return {...input_obj, error :errors };
    }else{
        return {...input_obj, error :null };
    }
